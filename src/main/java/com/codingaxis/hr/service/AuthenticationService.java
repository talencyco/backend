...
import com.codingaxis.hr.security.UserNotActivatedException;
import com.codingaxis.hr.security.UsernameNotFoundException;
...
public class AuthenticationService {
  ...
  public QuarkusSecurityIdentity authenticate(String login, String password) {
    ...
    if (this.passwordHasher.checkPassword(password, user.password)) {
